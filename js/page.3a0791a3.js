parcelRequire = function(e, r, t, n) {
		...
		! function(e, n) {
			...
			var e, n = function() {
				...
				return O.matches = function(t, e) {
						...
						var r, i = t.parentNode,
							o = !i;
						return o && (i = P)
							.appendChild(t), r = ~O.qsa(i, e)
							.indexOf(t), o && P.removeChild(t), r
					}, o = function(t) {
						...
						var o, a, s;
						return v.test(t) && (o = r(f.createElement(RegExp.$1))), o || (t.replace && (t = t.replace(g, "<$1></$2>")), n === e && (n = m.test(t) && RegExp.$1), n in T || (n = "*"), (s = T[n])
							.innerHTML = "" + t, o = r.each(l.call(s.childNodes), function() {
								s.removeChild(this)
					...
					.extend = function(t) {
						...
						return (a = s)
							.length > 0 ? r.fn.concat.apply([], a) : a
					}, r.each = function(t, e) {
						var n, r;
						if (Z(t)) {
						...
						has: function(t) {
							return this.filter(function() {
								return M(t) ? r.contains(this, t) : r(this)
									.find(t)
									.size()
							})
						},
						...
						show: function() {
							return this.each(function() {
								...
								"none" == this.style.display && (this.style.display = ""), "none" == getComputedStyle(this, "")
									.getPropertyValue("display") && (this.style.display = (t = this.nodeName, h[t] || (e = f.createElement(t), f.body.appendChild(e), n = getComputedStyle(e, "")
										.getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), h[t] = n), h[t]))
							})
						},
						...
						wrap: function(t) {
							var e = $(t);
							if (this[0] && !e) var n = r(t)
								.get(0),
								i = n.parentNode || this.length > 1;
							return this.each(function(o) {
								r(this)
									.wrapAll(e ? t.call(this, o) : i ? n.cloneNode(!0) : n)
							})
						},
						wrapAll: function(t) {
							if (this[0]) {
						...
						val: function(t) {
							...
							})) : this[0] && (this[0].multiple ? r(this[0])
								.find("option")
								.filter(function() {
						...
						css: function(t, e) {
							if (arguments.length < 2) {
								...
								if ("string" == typeof t) {
									if (!i) return;
									return i.style[o(t)] || getComputedStyle(i, "")
										.getPropertyValue(t)
								}
								if (D(t)) {
									if (!i) return;
						...
						index: function(t) {
							return t ? this.indexOf(r(t)[0]) : this.parent()
								.children()
								.indexOf(this[0])
						},
						hasClass: function(t) {
						...
						position: function() {
							if (this.length) {
								...
								return n.top -= parseFloat(r(t)
									.css("margin-top")) || 0, n.left -= parseFloat(r(t)
									.css("margin-left")) || 0, i.top += parseFloat(r(e[0])
									.css("border-top-width")) || 0, i.left += parseFloat(r(e[0])
						...
						offsetParent: function() {
							return this.map(function() {
								for (var t = this.offsetParent || f.body; t && !y.test(t.nodeName) && "static" == r(t)
			...
			return t.Zepto = n, void 0 === t.$ && (t.$ = n),
				function(e) {
					...
					function p(t, e, n, r) {
						if ((e = d(e))
							.ns) var i = (o = e.ns, new RegExp("(?:^| )" + o.replace(" ", " .* ?") + "(?: |$)"));
						var o;
						return (s[h(t)] || [])
							.filter(function(t) {
					...
					e.fn.delegate = function(t, e, n) {
							...
							return t && !a(t) ? (e.each(t, function(t, e) {
								...
								c && (l = function(t) {
									...
									if (a && a !== o) return n = e.extend(w(t), {
										...
										.apply(a, [n].concat(i.call(arguments, 1)))
								}), g(o, t, u, s, r, f || l)
							}))
							...
							return (t = a(t) || e.isPlainObject(t) ? e.Event(t) : T(t))
								._args = n, this.each(function() {
									t.type in l && "function" == typeof this[t.type] ? this[t.type]() : "dispatchEvent" in this ? this.dispatchEvent(t) : e(this)
										.triggerHandler(t, n)
								})
							...
							return this.each(function(o, s) {
								(r = w(a(t) ? e.Event(t) : t))
								._args = n, r.target = s, e.each(p(s, t.type || t), function(t, e) {
				...
				function(e) {
					...
					function p(t, n, r, i) {
						if (t.global) return function(t, n, r) {
							var i = e.Event(n);
							return e(t)
								.trigger(i, r), !i.isDefaultPrevented()
						}(n || o, r, i)
					}
					...
					h.href = t.location.href, e.active = 0, e.ajaxJSONP = function(n, r) {
						...
						var a, s, u = n.jsonpCallback,
							...
							h = function(t) {
								e(l)
									.triggerHandler("error", t || "abort")
							},
							p = {
								abort: h
							};
						return r && r.promise(p), e(l)
							.on("load error", function(i, o) {
								clearTimeout(s), e(l)
									.off()
									.remove(), "error" != i.type && a ? m(a[0], p, n, r) : v(null, o || "error", p, n, r), t[c] = f, a && e.isFunction(f) && f(a[0]), f = a = void 0
						...
						}(b), b.crossDomain || ((a = o.createElement("a"))
								.href = b.url, a.href = a.href, b.crossDomain = h.protocol + "//" + h.host != a.protocol + "//" + a.host), b.url || (b.url = t.location.toString()), (g = b.url.indexOf("#")) > -1 && (b.url = b.url.slice(0, g)),
							function(t) {
						...
						return s.length > 1 && (u.url = s[0], i = s[1]), u.success = function(t) {
							o.html(i ? e("<div>")
								.html(t.replace(a, ""))
								.find(i) : t), c && c.apply(o, arguments)
						}, e.ajax(u), this
					};
				...
				.fn.serializeArray = function() {
					...
					return this[0] && e.each(this[0].elements, function(r, o) {
						n = o.type, (t = o.name) && "fieldset" != o.nodeName.toLowerCase() && !o.disabled && "submit" != n && "reset" != n && "button" != n && "file" != n && ("radio" != n && "checkbox" != n || o.checked) && i(e(o)
							.val())
					}), r
	...
	"Bb20": [function(require, module, exports) {
		...
		delete Object.prototype.document, delete Object.prototype.location, window.requestAnimFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
			...
			t(window)
				.scrollTop() > .6 * t(window)
				.height() ? t(".background")
				.addClass("fixed") : t(".background")
				.removeClass("fixed")
		}, t(function() {
